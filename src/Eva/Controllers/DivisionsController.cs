...
namespace EVA.Controllers
{
    public class DivisionsController : Controller
    {
        ...
        public DivisionsController(EVAContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("DivisionID,iDivision")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DivisionID,iDivision")] Division division)
        {
